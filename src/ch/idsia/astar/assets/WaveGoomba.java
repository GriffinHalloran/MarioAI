...
import ch.idsia.astar.assets.LevelSceneSnapshot;
...
{
private LevelSceneSnapshot world;
private float amplitude = 10f;
private float lastSin;
private int sideWayCounter = 0;

public WaveGoomba(LevelSceneSnapshot world, int x, int y, int dir, int mapX, int mapY)
{
